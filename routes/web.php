...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('/add-news', [FrontEndController::class, 'addNews'])->name('add-news');
    Route::get('/add-user', [FrontEndController::class, 'addUser'])->name('add-user');
    ...
    Route::get('/list-news', [FrontEndController::class, 'listBlog'])->name('list-news');
    Route::get('/list-user', [FrontEndController::class, 'listUser'])->name('list-user');

    Route::get('/dashboard', [FrontEndController::class, 'dashboard'])->name('dashboard');
    Route::get('/user/{id}', [FrontEndController::class, 'singleUser'])->name('single.user');
    Route::get('/edit-user/{id}', [FrontEndController::class, 'editUser'])->name('edit.user');
