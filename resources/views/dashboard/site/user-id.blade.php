    ...
    <div class="main-content">
        <div class="page-content">
            <div class="container-fluid">
                ...
                @else 
                '/assets/images/{{ $member->membership_type }}.jpg' @endif
        ); 
        ...
        background-position: center;">
                        ...
                        <div>
                            ...
                            <div class="d-flex justify-content-center align-items-center" style="padding-top: 90px">
                                <img src="{{ asset($member->image) }}"
                                    style="height:7.2cm;width:7.2cm;border-radius:3.375rem" alt="">
                            ...
                            <div class="text-center p-2">
                                ...
                                <h6 style="text-transform: capitalize;font-size: 20px; font-weight: bolder; color:black;">
                                    mob :
                                    {{ $member->mobile }}</h6>
                            </div>
                ...
                <a href="{{ route('member.downloadCard', $member->id) }}" target="" class="btn btn-dark m-4">
                    Download Card (PDF)
                </a>
