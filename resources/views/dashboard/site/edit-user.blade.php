                                    ...
                                    <form method="POST" class="custom-validation"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label">WhatsApp No <span
                                                            style="color: red">*</span></label>
                                                    <input type="text" name="whatsapp" value="{{ $member->whatsapp }}"
                                                        class="form-control" placeholder="Type something" required />
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label">Zone / Area <span
                                                                style="color: red">*</span></label>
                                                        <input type="text" name="zone" value="{{ $member->zone }}"
                                                            class="form-control" placeholder="Type something" required />
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" name="pin"
                                                                value="{{ $member->pin }}" class="form-control"
                                                                placeholder="Type something" required />
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <select name="before_pdp" id="before_pdp"
                                                                class="form-control">
                                                                <option value="{{ $member->before_pdp }}" disabled
                                                                    selected>{{ $member->before_pdp }}</option>
