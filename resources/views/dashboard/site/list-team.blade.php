...
<head>
    ...
    <meta charset="utf-8" />
    <title>P C F -  People Culture Forum - Admin & Dashboard</title>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($teams  as $team)
                                            <tr>
                                                <td>{{ $team->id }}</td>
                                                <td>{{ $team->name }}</td>
                                                <td><img src="{{ $team->image }}" class="img-thumbnail"
                                                        style="width:60px;" alt="Blog"></td>
                                                <td>{{ $team->position }}</td>
                                                <td>{{ $team->created_at->format('F j Y') }}</td>
                                            </tr>
                                        @endforeach
                                        @endif
                                    </tbody>
