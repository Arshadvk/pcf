                    ...
                    <div class="inner-area">
                        ...
                        <div class="details">
                            <p >പി.വി.ഐ എന്ന സ്വതന്ത്രമായി പ്രവർത്തിക്കുകയായിരുന്ന സംഘടന രണ്ടായിരത്തിന് ശേഷം എല്ലാ ജിസിസി
                                ...
                                ചെയർമാൻ അബ്ദുൾനാസർ മഅദനിയെ സ്നേഹിക്കുന്ന സേവന മനോഭാവമുള്ള നിരവധി അഭ്യുദയകാംക്ഷികളുടെയും കൂട്ടായ
            ...
            <div>
                <div>
                    <div class="section-title-s4">
                        <h2 class="text-heading text-chilanka text-center" style="padding-top: 30px;">പി.സി.എഫ്&nbsp;യു.എ.ഇ&nbsp;നാഷണൽ&nbsp;കമ്മിറ്റി&nbsp;    {{ $activeCommittee->year }}                     </h2>
                    </div>
                </div>
            </div>
            <div class="row">
