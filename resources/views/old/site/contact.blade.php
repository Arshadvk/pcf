            ...
            <div class="container mx-auto max-w-[1200px] px-[12px] xl:max-w-full">
                <div class="grid grid-cols-2 md:grid-cols-1 gap-[60px] xl:gap-[40px] items-center">
                    ...
                    <div class="rounded-[16px] overflow-hidden">
                        <div class="bg-edpurple p-[40px] sm:p-[30px] xxs:p-[20px] space-y-[24px] text-[16px]">
                            ...
                            <div class="flex flex-wrap xxs:flex-col items-center xxs:items-start gap-[20px] gap-y-[10px] pb-[20px] text-white border-b border-white/30 last:border-0 last:pb-0">
                                ...
                                <div class="txt">
                                    ...
                                    <h4 class="font-medium text-[24px] xxs:text-[22px]"><a href="tel:+919061116222">+91 9061116222</a></h4>
                                </div>
                            </div>
                            ...
                            <div class="flex flex-wrap xxs:flex-col items-center xxs:items-start gap-[20px] gap-y-[10px] pb-[20px] text-white border-b border-white/30 last:border-0 last:pb-0">
                                ...
                                <div class="txt">
                                    <span class="font-normal">Send a Mail</span>
                                    <h4 class="font-medium text-[24px] xxs:text-[22px]"><a href="mailto:info@pcfgcc.com">info@pcfgcc.com</a></h4>
                                </div>
                            </div>
                        ...
                        <!-- video cover -->
                        <div class="relative">
                            <img src="assets/img/events/14.jpg" alt="video cover" class="w-full brightness-[80%]">
                    ...
                    <div>
                        <h2 class="text-[40px] md:text-[35px] sm:text-[30px] xxs:text-[28px] font-semibold text-edblue mb-[7px]"></h2>
