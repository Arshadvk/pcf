        ...
        <div class="translate-x-[100%] transition-transform ease-linear duration-300 fixed right-0 w-full max-w-[25%] xl:max-w-[30%] lg:max-w-[40%] md:max-w-[50%] sm:max-w-[60%] xxs:max-w-full bg-white h-full z-[100] overflow-auto">
            ...
            <div class="ed-sidebar-heading p-[20px] lg:p-[20px] border-b border-edgray/20">
                <div class="logo flex justify-between items-center">
                    <a href="/"><img style="height: 70px;" src="assets/img/logo.png" alt="logo"></a>
...
<header class="z-[99] top-0 inset-x-[100px] xxl:inset-x-[30px] xl:inset-x-0 bg-white rounded-bl-[10px] rounded-br-[10px]">
        <!-- top header -->
        <div class="bg-edblue flex items-center justify-between lg:justify-center lg:gap-x-[20px]">
            ...
            <div class="flex items-center gap-x-[32px] xl:gap-x-[15px] gap-y-[6px] py-[18px] pl-[30px] xl:pl-[10px] lg:pl-0 lg:order-2 sm:pt-0 sm:pb-[10px] xl:hidden">
                ...
                <a href="tel:+20866660112" class="flex items-center gap-x-[10px] font-light text-white/80">
                    ...
                    <span>+91-9061116222</span>
                </a>
            </div>

            <!-- notice -->
            <p class="font-medium text-white text-[16px] xxs:text-[14px] xl:pl-[15px] lg:order-1 lg:w-full lg:my-[10px] text-center lg:text-left sm:text-center">Organization:  <span class="text-edyellow">PEOPLE'S CULTURAL FORUM</span></p>
        ...
        <!-- bottom header -->
        <div class="px-[30px] xxl:px-[15px] lg:px-[20px] py-[28px] lg:py-[18px] flex justify-between">
            <div class="logo xxs:max-w-[40%]"><a href="/"><img  style="height: 70px" src="assets/img/logo.png" alt="logo" class="logo"></a></div>
            ...
            <div class="flex lg:items-center lg:gap-[60px] xxs:gap-[30px]">
                <div class="flex items-center gap-[100px] xl:gap-[30px] lg:gap-y-0">
                    ...
                    <div class="flex items-center gap-x-[30px] xxs:gap-[30px]">
                        <a href="/register" class="ed-btn to-go-to-sidebar-in-mobile lg:m-[20px]">Member Ship</a>
                    </div>

                    <div class="flex items-center gap-x-[30px] xxs:gap-[20px]">
                        <a href="/login" class="red-btn to-go-to-sidebar-in-mobile lg:m-[20px]">Login</a>
                    </div>
                </div>
